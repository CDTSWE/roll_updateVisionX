...
export IMAGINGSTUDY_HTTP_SENDER="${URL}elvasoft/fhir/4_0_0/ImagingStudy/\${FhirId}"
export SERVICE_REQUEST_HTTP_SENDER="${URL}elvasoft/fhir/4_0_0/ServiceRequest/\${FhirId}"
export PROCEDURE_HTTP_SENDER="${URL}elvasoft/fhir/4_0_0/Procedure/\${FhirId}"
